...
LABEL_MIN_DIST = 10
GEOJSON_LABEL_FONT_FAMILY = '"Heiti SC", sans-serif'

LANDMARK_DISTANCE_M_DEFAULT = 1000.0
LANDMARK_POINT_RADIUS = 12
LANDMARK_POINT_STROKE_WIDTH = 2
LANDMARK_POINT_OUTER_RADIUS = 16
LANDMARK_POINT_CENTER_DOT_RADIUS = 10
LANDMARK_POINT_INNER_OPACITY = 0.78
LANDMARK_POINT_OUTER_OPACITY = 0.58
LANDMARK_POINT_CENTER_DOT_FILL = "#E79B03"
...
LANDMARK_LABEL_FILL = GEOJSON_LABEL_FILL
...
def _apply_cover_mode_colors():
	...
	global LANDMARK_POINT_CENTER_DOT_FILL
	LANDMARK_POINT_CENTER_DOT_FILL = "#fefedf"
